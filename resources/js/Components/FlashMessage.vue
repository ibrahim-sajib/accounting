...
<template>
    <div class="mx-auto mt-4 max-w-7xl space-y-3 px-4 sm:px-6">
        ...
        <div
            v-if="error"
            class="flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-900 dark:bg-red-950/50 dark:text-red-300"
        >
            <svg class="mt-0.5 h-4 w-4 flex-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
